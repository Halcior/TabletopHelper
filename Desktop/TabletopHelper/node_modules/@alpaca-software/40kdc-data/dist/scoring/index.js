 ...
 */
export function recordSecondary(pg, round, vp, caps = {}) {
    ...
    const rounds = pg.rounds.map((c, idx) => idx === i ? { ...c, secondary: c.secondary + clamped } : c);
    return { ...pg, rounds };
}
/**
 ...
 */
export function scoreSecondary(pg, round, cardId, vp, caps = {}) {
