 ...
 * guessing.
 */
export declare function baseUnitPoints(unit: Unit, modelCount: number, ordinal?: number): number;
/**
 ...
 */
export declare function hostPointsTiers(unit: Unit, hostFaction?: Faction | null): readonly CostTier[];
/**
 ...
 */
export declare function hostUnitPoints(unit: Unit, modelCount: number, ordinal?: number, hostFaction?: Faction | null): number;
/**
 ...
 */
export declare function pointsTierMissing(unit: Unit, modelCount: number, ordinal?: number): boolean;
/**
 ...
 */
export declare function wargearPoints(unit: Unit, counts: ReadonlyMap<string, number>): number;
export {};
