...
function corpusWithFabricatedSecrets() {
    ...
    writeFileSync(join(lists, "fabricated-roster-secret.txt"), `Fictional Faction - Fabricated Roster Secret - [1000 pts]
...
describe("auditWtcCorpus privacy", () => {
    ...
    it("records a byte-exact ordered detachment raw-name mismatch without either value", () => {
        const differences = diffValues({ detachments: [{ id: "fictional-detachment", raw_name: "MixedCase! Detachment" }] }, { detachments: [{ id: "fictional-detachment", raw_name: "mixedcase! detachment" }] });
...
//# sourceMappingURL=audit-wtc.test.js.map