 ...
 */
export type AbilityEffect = SingleEffect | StanceSelectEffect | ChoiceEffect | SequenceEffect | RulesBundleEffect | NamedEffect | DiceGatedEffect | DiceTableEffect | ConditionalEffect | DicePoolAllocationEffect | SelectUnitsEffect | ForEachUnitEffect | MovementModifierEffect | AuraEffect | DesignateTargetEffect | RiskRewardEffect | IssueOrdersEffect | ResourceActionMenuEffect | LeaderModelAbilityGrantEffect | PersistentDesignationEffect;
/**
 * This interface was referenced by `0KdcBundledSchemas`'s JSON-Schema
...
export type AbilityEffect1 = SingleEffect | StanceSelectEffect | ChoiceEffect | SequenceEffect | RulesBundleEffect | NamedEffect | DiceGatedEffect | DiceTableEffect | ConditionalEffect | DicePoolAllocationEffect | SelectUnitsEffect | ForEachUnitEffect | MovementModifierEffect | AuraEffect | DesignateTargetEffect | RiskRewardEffect | IssueOrdersEffect | ResourceActionMenuEffect | LeaderModelAbilityGrantEffect | PersistentDesignationEffect;
/**
 ...
 */
export type RuleStateCoreRuleSlug = "benefit-of-cover" | "fall-back" | "ordered-retreat" | "advance" | "charge" | "fire-overwatch" | "overwatch-against-bearer" | "desperate-escape";
/**
 * This interface was referenced by `0KdcBundledSchemas`'s JSON-Schema
 ...
 */
export type AbilityEffect2 = SingleEffect | StanceSelectEffect | ChoiceEffect | SequenceEffect | RulesBundleEffect | NamedEffect | DiceGatedEffect | DiceTableEffect | ConditionalEffect | DicePoolAllocationEffect | SelectUnitsEffect | ForEachUnitEffect | MovementModifierEffect | AuraEffect | DesignateTargetEffect | RiskRewardEffect | IssueOrdersEffect | ResourceActionMenuEffect | LeaderModelAbilityGrantEffect | PersistentDesignationEffect;
/**
...
export interface MovementModifierEffect {
    ...
    target: "self" | "bearer" | "unit" | "attached-unit" | "attacker" | "defender" | "target" | "friendly-within-aura" | "enemy-within-aura" | "all-friendly" | "all-enemy";
    modifier: {
        move_type?: "normal" | "advance" | "pile-in" | "consolidation" | "reactive" | "surge" | "redeploy" | "scout" | "infiltrate" | "shoot-and-scoot";
        distance?: number | string;
        passthrough?: ("non-titanic-models" | "friendly-vehicles" | "friendly-monsters" | "terrain-le-4" | "tall-terrain" | "all-terrain")[];
...
export interface PersistentDesignationEffect {
    ...
    consumer: {
         ...
         */
        effect: SingleEffect | StanceSelectEffect | ChoiceEffect | SequenceEffect | RulesBundleEffect | NamedEffect | DiceGatedEffect | DiceTableEffect | ConditionalEffect | DicePoolAllocationEffect | SelectUnitsEffect | ForEachUnitEffect | MovementModifierEffect | AuraEffect | DesignateTargetEffect | RiskRewardEffect | IssueOrdersEffect | ResourceActionMenuEffect | LeaderModelAbilityGrantEffect | PersistentDesignationEffect;
    };
    duration: "phase" | "turn" | "battle-round" | "battle" | "until-next-command-phase";
}
/**
...
export interface AbilityScope {
    ...
    duration: "phase" | "turn" | "battle-round" | "battle" | "until-next-command-phase" | "until-next-movement-phase" | "until-next-battle-round" | "until-start-next-turn" | "one-use" | "permanent";
    range_inches?: number;
    [k: string]: unknown;
}
/**
